package com.exchange.tests.steps;

import static com.exchange.tests.util.ExchangeTestContainer.CHECK_SUCCESS;
import static com.exchange.tests.util.TestConstants.SYMBOLSPEC_ETH_XBT;
import static com.exchange.tests.util.TestConstants.SYMBOLSPEC_EUR_USD;
